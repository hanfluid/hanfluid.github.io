...
\address{St. Anthony Falls Laboratory, University of Minnesota}

\mobile{+1-612-425-6818}
\email{liux3790@umn.edu}
%\dateofbirth{January 1st, 1970}
%\homepage{www.posquit0.com} 
%\github{github.com/themagicalmammal}
\linkedin{linkedin.com/in/hliu2019/}
% \gitlab{gitlab-id}
...
%-------------------------------------------------------------------------------
 %	BIBLIOGRAPHY
 %-------------------------------------------------------------------------------
\addbibresource{cv/ref_presentations.bib}
\addbibresource{cv/ref_publications.bib}
...
%-------------------------------------------------------------------------------
\input{cv/US Residency}
\input{cv/summary.tex}
\input{cv/education.tex}
\input{cv/memberships}
\input{cv/experience.tex}
\input{cv/projects.tex}
\input{cv/skills.tex}
\input{cv/peer review experiences}
\input{cv/interviews}
\input{cv/honors and awards}
\input{cv/service}
