---
layout: distill
title: "Getting Started with CFD: A Beginner's Perspective"
description: A brief introduction to Computational Fluid Dynamics for those new to the field.
tags: CFD tutorial fluid-mechanics
...
authors:
  - name: Han Liu
    url: "https://hanliu.me"
    affiliations:
      name: SAFL, University of Minnesota
...
1. Start with the fundamentals of fluid mechanics (e.g., Kundu & Cohen's textbook)
2. Learn a programming language (Python or Fortran/C++)
