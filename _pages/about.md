...
My work focuses on multiphase turbulence, both incompressible and compressible, using interface-capturing, immersed boundary, and particle methods. Applications range from [ventilated supercavitation](/visualizations/#ventilated-cavity-flow) and [oil spills under breaking waves](/visualizations/#oil-dispersion-under-breaking-waves) to [COVID-19 airborne transmission](/visualizations/#covid-19-airborne-transmission) and [Richtmyer-Meshkov instability](/visualizations/#richtmyer-meshkov-instability).
